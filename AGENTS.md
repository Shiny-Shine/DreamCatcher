...
- 이후 채팅은 한 R 세부 단계씩 진행합니다. 기본적으로 파일을 직접 수정하지 않고 사용자가 따라 할 C++·Editor 절차를 안내합니다. 이번 계획·명세 수정 승인은 후속 소스·Config·에셋 수정 권한을 포함하지 않습니다.
...
- 사용자가 직접 구현하는 학습 방식 유지. 파일 수정은 해당 채팅에서 명시적으로 승인한 범위에 한정
